...
@dataclass
class PREFModelConfig(VanillaModelConfig):
    """PREF model config"""
...
class PREFModel(Model):
    """PREF Model

    Args:
        config: PREF configuration to instantiate model
    """

    def __init__(
        self,
        config: PREFModelConfig,
        **kwargs,
    ) -> None:
